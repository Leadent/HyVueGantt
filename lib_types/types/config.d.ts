...
import type { ChartRow, ConnectionPattern, ConnectionSpeed, ConnectionType, DayOptionLabel, GanttMilestone, LabelColumnConfig, SortState, TimeUnit, MarkerConnection, TimeaxisEvent, ConnectionRelation } from "./chart";
